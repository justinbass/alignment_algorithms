...
def writeOutput(finalScaffold):
    info="Scaffold_builder version 2.0 log file\n\nReference sequence: "+parameters["-r"]+"\n\n"
...
def scaffold(mapping):
    ...
    if len(scaffold)>0:writeFasta("Scaffold_"+str(scaffoldNumber),scaffold)
